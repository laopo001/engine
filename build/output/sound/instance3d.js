pc.extend(pc, (function () {
    ...
    if (pc.SoundManager.hasAudioContext()) {
        ...
        */
        ...
        var fallOff_1 = function (posOne, posTwo, refDistance, maxDistance, rollOffFactor, distanceModel) {
            offset_1 = offset_1.sub2(posOne, posTwo);
            ...
            if (distance < refDistance) {
                ...
                if (distanceModel === pc.DISTANCE_LINEAR) {
                    ...
                    result = distance / Math.pow(refDistance, -rollOffFactor);
                }
        ...
        Object.defineProperty(SoundInstance3d.prototype, 'position', {
            ...
            set: function (position) {
                ...
                if (this.source) {
                    ...
                    var factor = fallOff_1(lpos, this._position, this.refDistance, this.maxDistance, this.rollOffFactor, this.distanceModel);
                    var v = this.volume;
...
//# sourceMappingURL=instance3d.js.map