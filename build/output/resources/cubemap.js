pc.extend(pc, (function () {
    var CubemapHandler = /** @class */ (function () {
        ...
        CubemapHandler.prototype.open = function (url, data) { };
        CubemapHandler.prototype.patch = function (assetCubeMap, assets) {
            var self = this;
            var loaded = false;
        ...
        CubemapHandler.prototype._patchTexture = function () {
            this.registry._loader._handlers.cubemap._patchTextureFaces(this, this.registry);
        };
        CubemapHandler.prototype._patchTextureFaces = function (assetCubeMap, assets) {
