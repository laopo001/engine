pc.extend(pc, (function () {
    ...
    var JsonModelParser = /** @class */ (function () {
        ...
        JsonModelParser.prototype._parseNodes = function (_a) {
            var model = _a.model;
            var modelData = model;
            var nodes = [];
            var i;
        ...
        JsonModelParser.prototype._parseSkins = function (_a, nodes) {
            var model = _a.model;
            var modelData = model;
            var skins = [];
            var skinInstances = [];
        ...
        JsonModelParser.prototype._parseMorphs = function (_a, nodes) {
            var model = _a.model;
            var modelData = model;
            var morphs = [];
            var morphInstances = [];
        ...
        JsonModelParser.prototype._calculateTangentsMorphTarget = function (positions, normals, uvs, indices, tan1, tan2, mtIndices, tangents) {
        ...
        JsonModelParser.prototype._initMorphs = function (_a, morphs, vertexBuffers, _b) {
            var model = _a.model;
        ...
        JsonModelParser.prototype._parseVertexBuffers = function (_a) {
            var model = _a.model;
            var modelData = model;
            var vertexBuffers = [];
        ...
        JsonModelParser.prototype._parseIndexBuffers = function (_a, vertexBuffers) {
            var model = _a.model;
            var modelData = model;
        ...
        JsonModelParser.prototype._parseMeshes = function (_a, skins, morphs, vertexBuffers, indexBuffer, indexData) {
            var model = _a.model;
            var modelData = model;
            var meshes = [];
            var indexBase = 0;
        ...
        JsonModelParser.prototype._parseMeshInstances = function (_a, nodes, meshes, skins, skinInstances, morphs, morphInstances) {
            var model = _a.model;
            var modelData = model;
            var meshInstances = [];
            var i;
