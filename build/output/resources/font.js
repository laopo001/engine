pc.extend(pc, (function () {
    var FontHandler = /** @class */ (function () {
        ...
        FontHandler.prototype._loadTextures = function (url, data, callback) {
            var numTextures = 1;
            var numLoaded = 0;
            var error = null;
        ...
        FontHandler.prototype.open = function (url, data, asset) {
            var font;
            if (data.textures) {
        ...
        FontHandler.prototype.patch = function (asset, assets) {
