pc.extend(pc, (function () {
    ...
    var onCubemapAssetLoad = function (_a, attribute, newValue, oldValue) {
        ...
        for (var i = 0; i < props.length; i++) {
            if (this[props[i]] !== resources[i])
                this[props[i]] = resources[i];
        }
        this.update();
    };
    var MaterialHandler = /** @class */ (function () {
        function MaterialHandler(_a) {
            var assets = _a.assets, graphicsDevice = _a.graphicsDevice;
            this._assets = assets;
        ...
        MaterialHandler.prototype.open = function (url, data) {
        ...
        MaterialHandler.prototype._createPlaceholders = function () {
            var textures = {
        ...
        MaterialHandler.prototype._createParameters = function (data) {
            var parameters = [];
        ...
        MaterialHandler.prototype.patch = function (asset, assets) {
        ...
        MaterialHandler.prototype._onAssetChange = function (asset, attribute, value) {
            if (attribute === 'data') {
                this._updateStandardMaterial(asset, value, this._assets);
            }
        };
        MaterialHandler.prototype._onAssetUnload = function (_a) {
            var data = _a.data;
        ...
        MaterialHandler.prototype._updateStandardMaterial = function (asset, data, assets) {
                    ...
                    if (param.data && !(param.data instanceof pc.Texture)) {
                        ...
                        handler = material._assetHandlers[param.name] = {
                            ...
                            bind: function (_a) {
                                ...
                                data.parameters[i].data = resource;
                                material[data.parameters[i].name] = resource;
                                material.update();
                            },
                            add: function (asset) {
                                assets.load(asset);
                            ...
                            remove: function (_a) {
                                var resource = _a.resource;
                                if (material[data.parameters[i].name] === resource) {
