pc.extend(pc, (function () {
    ...
    var TextureHandler = /** @class */ (function () {
        ...
        TextureHandler.prototype.load = function (url, callback) {
            var self = this;
            var image;
            var urlWithoutParams = url.includes('?') ? url.split('?')[0] : url;
        ...
        TextureHandler.prototype.open = function (url, data) {
            if (!url)
                return;
            var texture;
            ...
            if ((data instanceof Image) || (data instanceof HTMLImageElement)) { // PNG, JPG or GIF
                ...
                var numBlocksAcross = void 0, numBlocksDown = void 0, numBlocks = void 0;
        ...
        TextureHandler.prototype.patch = function (_a, assets) {
            var resource = _a.resource, name = _a.name, data = _a.data;
