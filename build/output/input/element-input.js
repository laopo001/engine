pc.extend(pc, (function () {
    ...
    // pi x p2 * p3
    var scalarTriple = function (p1, p2, p3) { return _sct.cross(p1, p2).dot(p3); };
    /**
     * @constructor
     ...
     */
    var ElementInputEvent = /** @class */ (function () {
     ...
     */
    var ElementTouchEvent = function (_a, element, input) {
        var touches = _a.touches, changedTouches = _a.changedTouches;
     ...
     */
    var ElementInput = /** @class */ (function () {
         ...
         */
        ElementInput.prototype.detach = function () {
            if (!this._attached)
                return;
            this._attached = false;
         ...
         */
        ElementInput.prototype.addElement = function (element) {
         ...
         * @param {pc.ElementComponent} element The ElementComponent
         */
        ElementInput.prototype.removeElement = function (element) {
            var idx = this._elements.indexOf(element);
            if (idx !== -1)
                this._elements.splice(idx, 1);
        };
        ElementInput.prototype._handleUp = function (event) {
            if (pc.Mouse.isPointerLocked())
                return;
        ...
        ElementInput.prototype._handleDown = function (event) {
            if (pc.Mouse.isPointerLocked())
                return;
            this._calcMouseCoords(event);
            if (targetX === null)
        ...
        ElementInput.prototype._handleMove = function (event) {
            this._calcMouseCoords(event);
            if (targetX === null)
                return;
            this._onElementMouseEvent(event);
        ...
        ElementInput.prototype._handleWheel = function (event) {
            this._calcMouseCoords(event);
            if (targetX === null)
                return;
            this._onElementMouseEvent(event);
        };
        ElementInput.prototype._handleTouchStart = function (event) {
        ...
        ElementInput.prototype._handleTouchEnd = function (event) {
            var cameras = this.app.systems.camera.cameras;
        ...
        ElementInput.prototype._handleTouchMove = function (event) {
        ...
        ElementInput.prototype._onElementMouseEvent = function (event) {
            var element;
        ...
        ElementInput.prototype._fireEvent = function (name, evt) {
        ...
        ElementInput.prototype._calcMouseCoords = function (_a) {
        ...
        ElementInput.prototype._calcTouchCoords = function (touch) {
            var totalOffsetX = 0;
            var totalOffsetY = 0;
        ...
        ElementInput.prototype._sortElements = function (_a, _b) {
            var screen = _a.screen, drawOrder = _a.drawOrder;
            var screen = _b.screen, drawOrder = _b.drawOrder;
            if (screen && !screen)
                return -1;
            if (!screen && screen)
                return 1;
        ...
        ElementInput.prototype._getTargetElement = function (camera, x, y) {
            var result = null;
            // sort elements
        ...
        ElementInput.prototype._checkElement2d = function (x, y, element, _a) {
            var rect = _a.rect;
            var sw = this.app.graphicsDevice.width;
            var sh = this.app.graphicsDevice.height;
            var cameraWidth = rect.z * sw;
            var cameraHeight = rect.w * sh;
            var cameraLeft = rect.x * sw;
            var cameraRight = cameraLeft + cameraWidth;
            // camera bottom (origin is bottom left of window)
            var cameraBottom = (1 - rect.y) * sh;
        ...
        ElementInput.prototype._checkElement3d = function (x, y, element, camera) {
