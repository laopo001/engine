pc.extend(pc, (function () {
    ...
    var TouchEvent = /** @class */ (function () {
        function TouchEvent(device, event) {
            ...
            this.changedTouches = [];
            if (event) {
                var i = void 0, l = event.touches.length;
                for (i = 0; i < l; i++) {
     ...
     */
    var TouchDevice = /** @class */ (function () {
        ...
        */
        ...
        TouchDevice.prototype._handleTouchStart = function (e) {
            this.fire('touchstart', new TouchEvent(this, e));
        };
        TouchDevice.prototype._handleTouchEnd = function (e) {
            this.fire('touchend', new TouchEvent(this, e));
        };
        TouchDevice.prototype._handleTouchMove = function (e) {
            // call preventDefault to avoid issues in Chrome Android:
            // http://wilsonpage.co.uk/touch-events-in-chrome-android/
            e.preventDefault();
            this.fire('touchmove', new TouchEvent(this, e));
        };
        TouchDevice.prototype._handleTouchCancel = function (e) {
