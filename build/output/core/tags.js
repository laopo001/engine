...
(function (pc) {
    var TagsCache = /** @class */ (function () {
        ...
        TagsCache.prototype.removeItem = function (item) {
            var tags = item.tags._list;
            for (var i = 0; i < tags.length; i++)
                this.remove(tags[i], item);
        };
        TagsCache.prototype.add = function (tag, item) {
            // already in cache
        ...
        TagsCache.prototype.remove = function (tag, item) {
        ...
        TagsCache.prototype.find = function (args) {
            var self = this;
            var index = {};
            var items = [];
            var i, n, t;
            var item, tag, tags, tagsRest, missingIndex;
            var sort = function (a, b) { return self._index[a].list.length - self._index[b].list.length; };
    ...
    */
    var Tags = /** @class */ (function () {
        ...
        */
        ...
        Tags.prototype._has = function (tags) {
        ...
        */
        ...
        Tags.prototype._processArguments = function (args, flat) {
            var tags = [];
            var tmp = [];
            if (!args || !args.length)
                return tags;
