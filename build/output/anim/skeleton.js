pc.extend(pc, (function () {
    var InterpolatedKey = /** @class */ (function () {
        ...
        InterpolatedKey.prototype.setTarget = function (node) {
    ...
    var Skeleton = /** @class */ (function () {
        function Skeleton(graph) {
            ...
            this.graph = null;
            var self = this;
            function addInterpolatedKeys(_a) {
                var name = _a.name, _children = _a._children;
        ...
        Skeleton.prototype.addTime = function (delta) {
            if (this._animation !== null) {
                var i = void 0;
                var node = void 0, nodeName = void 0;
                var keys = void 0, interpKey = void 0;
                var k1 = void 0, k2 = void 0, alpha = void 0;
         ...
         */
        Skeleton.prototype.blend = function (_a, _b, alpha) {
            var _interpolatedKeys = _a._interpolatedKeys;
            var _interpolatedKeys = _b._interpolatedKeys;
            var numNodes = this._interpolatedKeys.length;
            for (var i = 0; i < numNodes; i++) {
                var key1 = _interpolatedKeys[i];
                var key2 = _interpolatedKeys[i];
