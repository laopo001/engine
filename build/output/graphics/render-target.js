...
(function (pc) {
    ...
    var RenderTarget = /** @class */ (function () {
        function RenderTarget(options, _arg2, _arg3) {
         ...
         */
        RenderTarget.prototype.resolve = function (color, depth) {
            if (!this._device)
                return;
         ...
         */
        RenderTarget.prototype.copy = function (source, color, depth) {
            if (!this._device) {
                if (source._device) {
