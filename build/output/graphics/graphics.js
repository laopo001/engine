...
(function (pc) {
     ...
     */
    pc.BLENDMODE_ONE_MINUS_DST_ALPHA = 10;
    /**
     ...
     */
    pc.PIXELFORMAT_111110F = 18;
    /**
     * @enum pc.PIXELFORMAT
     * @name pc.PIXELFORMAT_SRGB
     * @description Color-only sRGB format (WebGL2 only).
     */
    pc.PIXELFORMAT_SRGB = 19;
    /**
     * @enum pc.PIXELFORMAT
     * @name pc.PIXELFORMAT_SRGBA
     * @description Color sRGB format with additional alpha channel (WebGL2 only).
     */
    pc.PIXELFORMAT_SRGBA = 20;
    pc.PIXELFORMAT_ETC1 = 21;
    pc.PIXELFORMAT_PVRTC_2BPP_RGB_1 = 22;
    pc.PIXELFORMAT_PVRTC_2BPP_RGBA_1 = 23;
    pc.PIXELFORMAT_PVRTC_4BPP_RGB_1 = 24;
    pc.PIXELFORMAT_PVRTC_4BPP_RGBA_1 = 25;
