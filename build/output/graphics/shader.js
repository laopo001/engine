    ...
    var Shader = /** @class */ (function () {
        ...
        Shader.prototype.link = function () {
            ...
            if (!gl.getShaderParameter(this.vshader, gl.COMPILE_STATUS)) {
                pc.logERROR("Failed to compile vertex shader:\n\n" + addLineNumbers(this.definition.vshader) + "\n\n" + gl.getShaderInfoLog(this.vshader));
                retValue = false;
            }
            // fshader
            if (!gl.getShaderParameter(this.fshader, gl.COMPILE_STATUS)) {
                pc.logERROR("Failed to compile fragment shader:\n\n" + addLineNumbers(this.definition.fshader) + "\n\n" + gl.getShaderInfoLog(this.fshader));
                retValue = false;
            }
            // program
            if (!gl.getProgramParameter(this.program, gl.LINK_STATUS)) {
                pc.logERROR("Failed to link shader program. Error: " + gl.getProgramInfoLog(this.program));
                retValue = false;
            }
