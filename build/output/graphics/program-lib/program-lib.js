...
(function (pc) {
    pc.programlib = {
        ...
        precisionCode: function (_a) {
            var precision = _a.precision, webgl2 = _a.webgl2;
            var pcode = "precision " + precision + " float;\n";
            if (webgl2) {
                pcode += "#ifdef GL2\nprecision " + precision + " sampler2DShadow;\n#endif\n";
            }
            return pcode;
        },
        versionCode: function (_a) {
...
//# sourceMappingURL=program-lib.js.map