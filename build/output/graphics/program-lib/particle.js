pc.programlib.particle = {
    ...
    _animTex: function (_a, _b) {
        var animTexLoop = _a.animTexLoop;
        var particleAnimFrameLoopVS = _b.particleAnimFrameLoopVS, particleAnimFrameClampVS = _b.particleAnimFrameClampVS, particleAnimTexVS = _b.particleAnimTexVS;
        var vshader = "";
    ...
    createShaderDefinition: function (device, options) {
        ...
        if ((options.normal === 0) && (options.fog === "none"))
            options.srgb = false; // don't have to perform all gamma conversions when no lighting and fogging is used
