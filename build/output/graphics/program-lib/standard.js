...
(function (pc) {
    ...
    pc.standard = {
        ...
        _nonPointShadowMapProjection: function (_a, _b, shadowCoordArgs) {
            var webgl2 = _a.webgl2, extStandardDerivatives = _a.extStandardDerivatives;
            var _normalOffsetBias = _b._normalOffsetBias, _isVsm = _b._isVsm, _type = _b._type, _isPcf = _b._isPcf;
        ...
        createShaderDefinition: function (device, options) {
            ...
            if (options.cubeMap)
                options.sphereMap = null; // cubeMaps have higher priority
            if (options.dpAtlas)
                options.prefilteredCubemap = null; // dp has even higher priority
