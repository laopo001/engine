...
(function (pc) {
    ...
    */
    ...
    var GraphicsDevice = /** @class */ (function () {
        function GraphicsDevice(canvas, options) {
            ...
            (function () {
                ...
                this.commitFunction[pc.UNIFORMTYPE_MAT2] = function (_a, value) {
                    var locationId = _a.locationId;
                    gl.uniformMatrix2fv(locationId, false, value);
                };
                this.commitFunction[pc.UNIFORMTYPE_MAT3] = function (_a, value) {
                    var locationId = _a.locationId;
                    gl.uniformMatrix3fv(locationId, false, value);
                };
                this.commitFunction[pc.UNIFORMTYPE_MAT4] = function (_a, value) {
                    var locationId = _a.locationId;
                    gl.uniformMatrix4fv(locationId, false, value);
                };
                this.commitFunction[pc.UNIFORMTYPE_FLOATARRAY] = function (_a, value) {
                    var locationId = _a.locationId;
        ...
        GraphicsDevice.prototype.initializeCapabilities = function () {
            var gl = this.gl;
        ...
        GraphicsDevice.prototype.initializeRenderState = function () {
            var gl = this.gl;
        ...
        GraphicsDevice.prototype.initializeContext = function () {
            this.initializeExtensions();
            this.initializeCapabilities();
            this.initializeRenderState();
         ...
         */
        GraphicsDevice.prototype.setViewport = function (x, y, w, h) {
         ...
         */
        GraphicsDevice.prototype.setScissor = function (x, y, w, h) {
        ...
        GraphicsDevice.prototype.setFramebuffer = function (fb) {
            if (this.activeFramebuffer !== fb) {
                this.gl.bindFramebuffer(this.gl.FRAMEBUFFER, fb);
                this.activeFramebuffer = fb;
            }
        };
        GraphicsDevice.prototype._checkFbo = function () {
            // Ensure all is well
            var gl = this.gl;
        ...
        GraphicsDevice.prototype.copyRenderTarget = function (source, dest, color, depth) {
            var gl = this.gl;
        ...
        GraphicsDevice.prototype.initializeTexture = function (texture) {
            var gl = this.gl;
            var ext;
        ...
        GraphicsDevice.prototype.uploadTexture = function (texture) {
            var gl = this.gl;
        ...
        GraphicsDevice.prototype.setTexture = function (texture, textureUnit) {
            var gl = this.gl;
         ...
         * )};
         */
        GraphicsDevice.prototype.draw = function (_a, numInstances) {
            var type = _a.type, count = _a.count, indexed = _a.indexed, base = _a.base;
            var gl = this.gl;
            ...
            if (this.attributesInvalidated) {
                var attribute = void 0, element = void 0, vertexBuffer = void 0, vbOffset = void 0, bufferId = void 0;
            ...
            this._primsPerFrame[type] += count * (numInstances > 1 ? numInstances : 1);
            ...
            if (indexed) {
                if (numInstances > 1) {
                    this.extInstancing.drawElementsInstancedANGLE(this.glPrimitive[type], count, this.indexBuffer.glFormat, base * 2, numInstances);
                    this.boundBuffer = null;
                    this.attributesInvalidated = true;
                }
                else {
                    gl.drawElements(this.glPrimitive[type], count, this.indexBuffer.glFormat, base * this.indexBuffer.bytesPerIndex);
                }
            }
            else {
                if (numInstances > 1) {
                    this.extInstancing.drawArraysInstancedANGLE(this.glPrimitive[type], base, count, numInstances);
                    this.boundBuffer = null;
                    this.attributesInvalidated = true;
                }
                else {
                    gl.drawArrays(this.glPrimitive[type], base, count);
                }
            }
            if (this.webgl2 && this.transformFeedbackBuffer) {
                // disable TF
        ...
        GraphicsDevice.prototype.readPixels = function (x, y, w, h, pixels) {
            var gl = this.gl;
        ...
        GraphicsDevice.prototype.setClearStencil = function (value) {
         ...
         */
        GraphicsDevice.prototype.setRenderTarget = function (renderTarget) {
         ...
         */
        GraphicsDevice.prototype.getDepthTest = function () {
         ...
         */
        GraphicsDevice.prototype.getDepthWrite = function () {
         ...
         */
        GraphicsDevice.prototype.setAlphaToCoverage = function (state) {
            if (!this.webgl2)
                return;
         ...
         */
        GraphicsDevice.prototype.setTransformFeedbackBuffer = function (tf) {
         ...
         */
        GraphicsDevice.prototype.setRaster = function (on) {
            if (this.raster === on)
                return;
            this.raster = on;
            if (this.webgl2) {
        ...
        GraphicsDevice.prototype.setDepthBias = function (on) {
        ...
        GraphicsDevice.prototype.setDepthBiasValues = function (constBias, slopeBias) {
         ...
         */
        GraphicsDevice.prototype.setStencilTest = function (enable) {
         ...
         */
        GraphicsDevice.prototype.setStencilFunc = function (func, ref, mask) {
         ...
         * @param {Number} mask Mask applied to stencil buffer value and reference value before comparison.
         */
        GraphicsDevice.prototype.setStencilFuncFront = function (func, ref, mask) {
            if (this.stencilFuncFront !== func || this.stencilRefFront !== ref || this.stencilMaskFront !== mask) {
                var gl = this.gl;
         ...
         * @param {Number} mask Mask applied to stencil buffer value and reference value before comparison.
         */
        GraphicsDevice.prototype.setStencilFuncBack = function (func, ref, mask) {
         ...
         */
        GraphicsDevice.prototype.setStencilOperation = function (fail, zfail, zpass, writeMask) {
         ...
         * @param {Number} writeMask A bit mask applied to the reference value, when written.
         */
        GraphicsDevice.prototype.setStencilOperationFront = function (fail, zfail, zpass, writeMask) {
            if (this.stencilFailFront !== fail || this.stencilZfailFront !== zfail || this.stencilZpassFront !== zpass) {
         ...
         * @param {Number} writeMask A bit mask applied to the reference value, when written.
         */
        GraphicsDevice.prototype.setStencilOperationBack = function (fail, zfail, zpass, writeMask) {
         ...
         */
        GraphicsDevice.prototype.setVertexBuffer = function (vertexBuffer, stream, vbOffset) {
        ...
        GraphicsDevice.prototype.getHdrFormat = function () {
        ...
        */
        GraphicsDevice.prototype.resizeCanvas = function (width, height) {
            this._width = width;
            this._height = height;
        ...
        GraphicsDevice.prototype.setResolution = function (width, height) {
            this._width = width;
            this._height = height;
            this.canvas.width = width;
            this.canvas.height = height;
        ...
        */
        GraphicsDevice.prototype.clearShaderCache = function () {
            this.programLib.clearCache();
        };
        GraphicsDevice.prototype.removeShaderFromCache = function (shader) {
            this.programLib.removeFromCache(shader);
        };
        GraphicsDevice.prototype.destroy = function () {
    ...
    pc.GraphicsDevice = GraphicsDevice;
    // /**
    //  * @readonly
    //  * @name pc.GraphicsDevice#maxAnisotropy
    //  * @type Number
