...
(function (pc) {
    ...
    function syncToCpu(device, _a, face) {
    ...
    function prefilterCubemap(options) {
        ...
        var shader = chunks.createShaderFromCode(device, chunks.fullscreenQuadVS, chunks.rgbmPS +
            chunks.prefilterCubemapPS.
                ...
                replace(/\$textureCube/g, rgbmSource ? "textureCubeRGBM" : "textureCube"), "prefilter" + method + samples + rgbmSource);
        ...
        for (pass = startPass; pass < cmapsList.length; pass++) {
            if (cmapsList[pass] != null) {
                ...
                for (i = 0; i < numMips; i++) {
                    for (face = 0; face < 6; face++) {
                        targ = new pc.RenderTarget(device, cmapsList[pass][i], {
                            face: face,
                            depth: false
                        });
                        params.x = face;
    ...
    pc.prefilterCubemap = prefilterCubemap;
    ...
    function shFromCubemap(_a, dontFlipX) {
        var width = _a.width, format = _a.format, _levels = _a._levels, rgbm = _a.rgbm;
        var face;
        var cubeSize = width;
        var x, y;
    ...
    pc.shFromCubemap = shFromCubemap;
})(pc || (pc = {}));
//# sourceMappingURL=prefilter-cubemap.js.map