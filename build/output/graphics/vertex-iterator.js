var pc;
(function (pc) {
    function VertexIteratorSetter(buffer, _a) {
        var dataType = _a.dataType, offset = _a.offset, numComponents = _a.numComponents;
        this.index = 0;
        switch (dataType) {
            case pc.TYPE_INT8:
     ...
     */
    var VertexIterator = /** @class */ (function () {
         ...
         * iterator.end();
         */
        VertexIterator.prototype.end = function () {
            // Unlock the vertex buffer
            this.vertexBuffer.unlock();
        };
        return VertexIterator;
    }());
    pc.VertexIterator = VertexIterator;
})(pc || (pc = {}));
//# sourceMappingURL=vertex-iterator.js.map