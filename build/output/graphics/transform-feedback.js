...
(function (pc) {
    ...
    var TransformFeedback = /** @class */ (function () {
         ...
         */
        TransformFeedback.prototype.process = function (shader, swap) {
            if (swap === undefined)
                swap = true;
    ...
    pc.TransformFeedback = TransformFeedback;
    /**
     * @function
     ...
     */
    TransformFeedback.createShader = function (graphicsDevice, vsCode, name) { return pc.shaderChunks.createShaderFromCode(graphicsDevice, vsCode, null, name, true); };
})(pc || (pc = {}));
