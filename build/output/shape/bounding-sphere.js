...
(function (pc) {
    ...
    var BoundingSphere = /** @class */ (function () {
        ...
        BoundingSphere.prototype.compute = function (vertices) {
            var i;
         ...
         */
        BoundingSphere.prototype.intersectsRay = function (_a, point) {
            var origin = _a.origin, direction = _a.direction;
            var m = tmpVecA.copy(origin).sub(this.center);
            var b = m.dot(tmpVecB.copy(direction).normalize());
         ...
         */
        BoundingSphere.prototype.intersectsBoundingSphere = function (_a) {
            var center = _a.center, radius = _a.radius;
            tmpVecA.sub2(center, this.center);
            var totalRadius = radius + this.radius;
    ...
    pc.BoundingSphere = BoundingSphere;
})(pc || (pc = {}));
