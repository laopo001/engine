...
(function (pc) {
    ...
    var Curve = /** @class */ (function () {
        ...
        Curve.prototype.value = function (time) {
            ...
            if (this.type === pc.CURVE_SMOOTHSTEP) {
                interpolation *= interpolation * (3 - 2 * interpolation);
            }
            else if (this.type === pc.CURVE_CATMULL || this.type === pc.CURVE_CARDINAL) {
                var p1 = leftValue;
                var p2 = rightValue;
