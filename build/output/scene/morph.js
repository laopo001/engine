pc.extend(pc, (function () {
    ...
    pc.extend(Morph.prototype, {
        ...
        _setBaseMesh: function (_a) {
            var vertexBuffer = _a.vertexBuffer, _aabb = _a._aabb;
    ...
    */
    var MorphInstance = /** @class */ (function () {
         ...
         */
        MorphInstance.prototype.destroy = function () {
         ...
         */
        MorphInstance.prototype.getWeight = function (index) {
         ...
         */
        MorphInstance.prototype.setWeight = function (index, weight) {
         ...
         */
        MorphInstance.prototype.updateBounds = function (mesh) {
         ...
         */
        MorphInstance.prototype.update = function (mesh) {
            if (this.morph._baseBuffer !== mesh.vertexBuffer) {
                this.morph._setBaseMesh(mesh);
            }
            if (!this._vertexData) {
