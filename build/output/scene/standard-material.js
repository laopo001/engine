pc.extend(pc, (function () {
     ...
     * @extends pc.Material
     */
    var StandardMaterial = /** @class */ (function () {
    ...
    var _createTexture = function (_a) {
        var data = _a.data;
        if (data) {
    ...
    var _createCubemap = function (_a) {
        var data = _a.data;
        if (data) {
            if (data instanceof pc.Texture) {
                return data;
    ...
    var _createVec2 = function (_a) {
        var data = _a.data;
        return new pc.Vec2(data[0], data[1]);
    };
    var _createBoundingBox = function (_a) {
        var data = _a.data;
    ...
    var _defineColor = function (obj, name, defaultValue, hasMultiplier) {
        ...
        _prop2Uniform[name] = function (mat, _a, changeMat) {
            var data = _a.data;
    ...
    var _defineFloat = function (obj, name, defaultValue, func) {
        ...
        _propsSerial.push(name);
        _prop2Uniform[name] = func !== undefined ? func : (function (mat, val, changeMat) { return ({
            name: ("material_" + name),
            value: val
        }); });
    };
    ...
    pc.extend(StandardMaterial.prototype, {
        ...
        */
        init: function (_a) {
            var name = _a.name, chunks = _a.chunks, parameters = _a.parameters;
            this.reset();
        ...
        _updateMapTransform: function (transform, _a, _b) {
            var x = _a.x, y = _a.y;
            var x = _b.x, y = _b.y;
            ...
            if (prefilteredCubeMap128) {
                ...
                if (useDp && allMips) {
                    if (!prefilteredCubeMap128.dpAtlas) {
                        prefilteredCubeMap128.dpAtlas = pc.generateDpAtlas(device, [prefilteredCubeMap128, prefilteredCubeMap64, prefilteredCubeMap32, prefilteredCubeMap16,
    ...
    var _defineMaterialProps = function (obj) {
        ...
        _defineFloat(obj, "shininess", 25, function (_a, shininess) {
            var shadingModel = _a.shadingModel;
        ...
        _defineFloat(obj, "heightMapFactor", 1, function (mat, height) { return ({
        ...
        _defineObject(obj, "ambientSH", function (mat, val, changeMat) { return ({
            name: "ambientSH[0]",
            value: val
        }); });
        _defineObject(obj, "cubeMapProjectionBox", function (_a, _b, changeMat) {
            var cubeMapMinUniform = _a.cubeMapMinUniform, cubeMapMaxUniform = _a.cubeMapMaxUniform;
            var center = _b.center, halfExtents = _b.halfExtents;
            var bmin = changeMat ? cubeMapMinUniform : new Float32Array(3);
            var bmax = changeMat ? cubeMapMaxUniform : new Float32Array(3);
