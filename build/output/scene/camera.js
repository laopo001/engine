pc.extend(pc, (function () {
    ...
    var Camera = /** @class */ (function () {
         ...
         */
        Camera.prototype.worldToScreen = function (worldCoord, cw, ch, screenCoord) {
         ...
         */
        Camera.prototype.screenToWorld = function (x, y, z, cw, ch, worldCoord) {
         ...
         */
        Camera.prototype.getClearOptions = function () {
         ...
         */
        Camera.prototype.setClearOptions = function (_a) {
            var color = _a.color, depth = _a.depth, stencil = _a.stencil, flags = _a.flags;
            this._clearOptions.color[0] = color[0];
            this._clearOptions.color[1] = color[1];
            this._clearOptions.color[2] = color[2];
            this._clearOptions.color[3] = color[3];
            this._clearOptions.depth = depth;
            this._clearOptions.stencil = stencil;
            this._clearOptions.flags = flags;
        };
        Camera.prototype.setRect = function (x, y, width, height) {
            this._rect.x = x;
            this._rect.y = y;
            this._rect.width = width;
            this._rect.height = height;
        };
        Camera.prototype.setScissorRect = function (x, y, width, height) {
            this._scissorRect.x = x;
            this._scissorRect.y = y;
            this._scissorRect.width = width;
            this._scissorRect.height = height;
        };
        Camera.prototype.requestDepthMap = function () {
            this._renderDepthRequests++;
        };
        Camera.prototype.releaseDepthMap = function () {
            this._renderDepthRequests--;
        };
