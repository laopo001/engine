pc.extend(pc, (function () {
    ...
    var SkinPartition = /** @class */ (function () {
        ...
        SkinPartition.prototype.addVertex = function (vertex, idx, _a) {
            var blendWeight = _a.blendWeight, blendIndices = _a.blendIndices;
            var remappedIndex = -1;
            if (this.indexMap[idx] !== undefined) {
                ...
                for (var influence = 0; influence < 4; influence++) {
                    if (blendWeight.data[idx * 4 + influence] === 0)
                        continue;
                    var originalBoneIndex = blendIndices.data[vertex.index * 4 + influence];
        ...
        SkinPartition.prototype.addPrimitive = function (vertices, vertexIndices, vertexArray, boneLimit) {
    ...
    function partitionSkin(model, materialMappings, boneLimit) {
        ...
        for (i = skins.length - 1; i >= 0; i--) {
            ...
            if (skins[i].boneNames.length > boneLimit) {
                ...
                var attrib = void 0, attribName = void 0, data = void 0, components = void 0;
...
//# sourceMappingURL=skin-partition.js.map