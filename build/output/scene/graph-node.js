pc.extend(pc, (function () {
    ...
    pc.extend(GraphNode.prototype, {
        ...
        findByTag: function () {
            ...
            var tags = this.tags._processArguments(args);
            ...
            if (this._dirtyWorld) {
                if (this._parent === null) {
                    ...
                    if (this.scaleCompensation) {
                        ...
                        var parentToUseScaleFrom = parent_1; // current parent
                        ...
                        scaleCompensateRot2.setFromMat4(parent_1.worldTransform);
                        scaleCompensateRot.mul2(scaleCompensateRot2, this.localRotation);
                        // Find matrix to transform position
                        var tmatrix = parent_1.worldTransform;
                        if (parent_1.scaleCompensation) {
                            scaleCompensateScaleForParent.mul2(parentWorldScale, parent_1.getLocalScale());
                            scaleCompensatePosTransform.setTRS(parent_1.worldTransform.getTranslation(scaleCompensatePos), scaleCompensateRot2, scaleCompensateScaleForParent);
