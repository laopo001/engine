pc.extend(pc, (function () {
     ...
     */
    var MeshInstance = /** @class */ (function () {
            ...
            get: function () {
                ...
                if (this.skinInstance) {
                    ...
                    if (!this.mesh.boneAabb) {
                        ...
                        var index = void 0;
                        var offsetP = void 0, offsetI = void 0, offsetW = void 0;
                        var j = void 0, k = void 0, l = void 0;
                        ...
                        if (this.morphInstance) {
                            ...
                            var m = void 0, dx = void 0, dy = void 0, dz = void 0;
                            var target = void 0, mtIndices = void 0, mtIndicesLength = void 0, deltaPos = void 0;
                            for (j = 0; j < numVerts; j++) {
    ...
    pc.extend(MeshInstance.prototype, {
        ...
        updateKey: function () {
            ...
            this._key[pc.SORTKEY_FORWARD] = getKey(this.layer, (material.alphaToCoverage || material.alphaTest) ? pc.BLEND_NORMAL : material.blendType, // render alphatest/atoc after opaque
            false, material.id);
        },
    ...
    var InstancingData = /** @class */ (function () {
