pc.extend(pc.Application.prototype, (function () {
    ...
    var ImmediateData = /** @class */ (function () {
        ...
        ImmediateData.prototype.getLayerIdx = function (_a) {
            var id = _a.id;
            return this.layerToBatch[id];
        };
        ImmediateData.prototype.addLayerIdx = function (idx, _a) {
            var id = _a.id;
            this.layerToBatch[id] = idx;
        };
        return ImmediateData;
    }());
    var LineBatch = /** @class */ (function () {
        function LineBatch() {
        ...
        LineBatch.prototype.addLines = function (position, color) {
        ...
        LineBatch.prototype.finalize = function () {
