pc.extend(pc, (function () {
    ...
    var Light = /** @class */ (function () {
        ...
        Light.prototype.getBoundingSphere = function (sphere) {
        ...
        Light.prototype.getBoundingBox = function (box) {
            if (this._type === pc.LIGHTTYPE_SPOT) {
                var range = this.attenuationEnd;
                var angle = this._outerConeAngle;
                var node = this._node;
        ...
        Light.prototype.setColor = function () {
            var args = [];
            ...
            for (var c = 0; c < 3; c++) {
                if (i >= 1) {
                    this._linearFinalColor.data[c] = this._finalColor.data[c] / Math.pow(i, 2.2) * i;
                }
                else {
        ...
        Light.prototype.updateShadow = function () {
            if (this.shadowUpdateMode !== pc.SHADOWUPDATE_REALTIME) {
                this.shadowUpdateMode = pc.SHADOWUPDATE_THISFRAME;
            }
        };
        Light.prototype.updateKey = function () {
            // Key definition:
            // Bit
            // 31      : sign bit (leave)
            // 29 - 30 : type
        ...
        Object.defineProperty(Light.prototype, "intensity", {
            ...
            set: function (value) {
                ...
                for (var j = 0; j < 3; j++) {
                    if (i >= 1) {
                        this._linearFinalColor.data[j] = this._finalColor.data[j] / Math.pow(i, 2.2) * i;
                    }
                    else {
