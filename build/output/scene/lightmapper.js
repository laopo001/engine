pc.extend(pc, (function () {
     ...
     */
    var Lightmapper = /** @class */ (function () {
        ...
        Lightmapper.prototype.calculateLightmapSize = function (_a) {
            var model = _a.model, localScale = _a.localScale, _parent = _a._parent;
            var data, parent;
            ...
            var areaMult = model.lightmapSizeMultiplier || 1;
            area.x *= areaMult;
            area.y *= areaMult;
            area.z *= areaMult;
         ...
         */
        Lightmapper.prototype.bake = function (nodes, mode) {
            // #ifdef PROFILER
...
//# sourceMappingURL=lightmapper.js.map