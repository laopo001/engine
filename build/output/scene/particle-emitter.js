...
pc.extend(pc, (function () {
    ...
    function syncToCpu(device, _a) {
        var _colorBuffer = _a._colorBuffer, _glFrameBuffer = _a._glFrameBuffer;
        var tex = _colorBuffer;
    ...
    var ParticleEmitter = /** @class */ (function () {
        function ParticleEmitter(graphicsDevice, options) {
            ...
            if (!ParticleEmitter.DEFAULT_PARAM_TEXTURE) {
                ...
                var x = void 0, y = void 0, xgrad = void 0, ygrad = void 0, p = void 0, c = void 0;
        ...
        ParticleEmitter.prototype.calculateBoundsMad = function () {
        ...
        ParticleEmitter.prototype.calculateWorldBounds = function () {
            if (!this.node)
                return;
        ...
        ParticleEmitter.prototype.calculateLocalBounds = function () {
        ...
        ParticleEmitter.prototype.rebuild = function () {
            var i, len;
        ...
        ParticleEmitter.prototype._isAnimated = function () {
        ...
        ParticleEmitter.prototype.calcSpawnPosition = function (emitterPos, i) {
            var rX = Math.random();
            var rY = Math.random();
            var rZ = Math.random();
            var rW = Math.random();
        ...
        ParticleEmitter.prototype.rebuildGraphs = function () {
            var precision = this.precision;
            var gd = this.graphicsDevice;
            var i;
        ...
        ParticleEmitter.prototype._initializeTextures = function () {
            if (this.colorMap) {
        ...
        ParticleEmitter.prototype.regenShader = function () {
        ...
        ParticleEmitter.prototype.resetMaterial = function () {
        ...
        ParticleEmitter.prototype._allocate = function (numParticles) {
            ...
            if ((this.vertexBuffer === undefined) || (this.vertexBuffer.getNumVertices() !== psysVertCount)) {
                ...
                var meshData = void 0, stride = void 0;
                if (this.useMesh) {
                    meshData = new Float32Array(this.mesh.vertexBuffer.lock());
                    stride = meshData.length / this.mesh.vertexBuffer.numVertices;
                }
                var id = void 0, rnd = void 0;
        ...
        ParticleEmitter.prototype.prewarm = function (time) {
        ...
        ParticleEmitter.prototype.resetTime = function () {
            this.endTime = calcEndTime(this);
        };
        ParticleEmitter.prototype.finishFrame = function () {
            if (this.useCpu)
                this.vertexBuffer.unlock();
        };
        ParticleEmitter.prototype.addTime = function (delta, isOnStop) {
            var a, b, c, i, j;
            ...
            if (!this.useCpu) {
                ...
                var vertSize = 14;
                var cf = void 0, cc = void 0;
                var rotSpeed = void 0, rotSpeed2 = void 0, scale2 = void 0, alpha = void 0, alpha2 = void 0;
                ...
                if (this.sort > pc.PARTICLESORT_NONE && this.camera) {
                    ...
                    this.vbToSort.sort(function (a, b) { return a[1] - b[1]; });
                    for (i = 0; i < this.numParticles; i++) {
    ...
    function calcEndTime(_a) {
        var rate = _a.rate, rate2 = _a.rate2, numParticles = _a.numParticles, lifetime = _a.lifetime;
        var interval = (Math.max(rate, rate2) * numParticles + lifetime);
