pc.extend(pc, (function () {
    ...
    function sortDrawCalls(_a, _b) {
        var layer = _a.layer, drawOrder = _a.drawOrder, key = _a.key;
        var layer = _b.layer, drawOrder = _b.drawOrder, key = _b.key;
        if (layer === layer) {
    ...
    var Picker = /** @class */ (function () {
        ...
        Picker.prototype.prepare = function (camera, scene, arg) {
            ...
            if (!this.layer) {
                var pickColorId_1 = device.scope.resolve('uColor');
                this.layer = new pc.Layer({
                    ...
                    onDrawCall: function (meshInstance, i) {
                        ...
                        pickColorId_1.setValue(self.pickColor);
            ...
            if (!sourceLayer) {
                ...
                var j;
                var instanceList;
                var layerCamId = void 0;
                var instanceListLength;
                var drawCall;
                var transparent = void 0;
        ...
        Picker.prototype.onLayerPostRender = function (_a) {
            var cameras = _a.cameras, oldClear = _a.oldClear, oldAspectMode = _a.oldAspectMode, oldAspect = _a.oldAspect;
