pc.extend(pc, (function () {
    ...
    var VrManager = /** @class */ (function () {
        ...
        VrManager.prototype._detach = function () {
         ...
         */
        VrManager.prototype.destroy = function () {
            this._detach();
        };
        /**
         * @function
         ...
         */
        VrManager.prototype.poll = function () {
        ...
        VrManager.prototype._getDisplays = function (callback) {
        ...
        VrManager.prototype._addDisplay = function (vrDisplay) {
        ...
        VrManager.prototype._onDisplayConnect = function (_a) {
            var detail = _a.detail, display = _a.display;
        ...
        VrManager.prototype._onDisplayDisconnect = function (e) {
            var id;
