pc.extend(pc, (function () {
    ...
    var VrDisplay = /** @class */ (function () {
        ...
        */
        VrDisplay.prototype.poll = function () {
            if (this.display) {
        ...
        */
        VrDisplay.prototype.requestPresent = function (callback) {
            if (!this.display) {
                if (callback)
        ...
        */
        VrDisplay.prototype.exitPresent = function (callback) {
            if (!this.display) {
                if (callback)
        ...
        */
        VrDisplay.prototype.requestAnimationFrame = function (fn) {
            if (this.display)
        ...
        */
        VrDisplay.prototype.reset = function () {
            if (this.display)
        ...
        */
        VrDisplay.prototype.setClipPlanes = function (n, f) {
            if (this.display) {
