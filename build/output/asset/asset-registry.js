    ...
    var AssetRegistry = /** @class */ (function () {
        ...
        */
        AssetRegistry.prototype.list = function (filters) {
            filters = filters || {};
            return this._assets.filter(function (_a) {
        ...
        */
        AssetRegistry.prototype.add = function (asset) {
        ...
        */
        AssetRegistry.prototype.remove = function (asset) {
        ...
        * var asset = app.assets.get(100);
        */
        AssetRegistry.prototype.get = function (id) {
        ...
        */
        AssetRegistry.prototype.getByUrl = function (url) {
        ...
        * }
        */
        AssetRegistry.prototype.load = function (asset) {
            if (asset.loading)
                return;
            var self = this;
        ...
        * });
        */
        AssetRegistry.prototype.loadFromUrl = function (url, type, callback) {
            var self = this;
        ...
        AssetRegistry.prototype._loadModel = function (asset, callback) {
            var self = this;
            var url = asset.getFileUrl();
        ...
        // private method used for engine-only loading of model data
        AssetRegistry.prototype._loadMaterials = function (dir, mapping, callback) {
            var self = this;
            var i;
        ...
        // private method used for engine-only loading of model data
        AssetRegistry.prototype._loadTextures = function (materials, callback) {
            var self = this;
            var i, j;
        ...
        */
        AssetRegistry.prototype.findAll = function (name, type) {
            var self = this;
            var idxs = this._names[name];
            var assets;
            if (idxs) {
                assets = idxs.map(function (idx) { return self._assets[idx]; });
                if (type) {
                    return assets.filter(function (asset) { return asset.type === type; });
                }
                else {
                    return assets;
                }
        ...
        AssetRegistry.prototype._onTagAdd = function (tag, asset) {
            this._tags.add(tag, asset);
        };
        AssetRegistry.prototype._onTagRemove = function (tag, asset) {
        ...
        */
        AssetRegistry.prototype.findByTag = function () {
            var args = [];
        ...
        */
        AssetRegistry.prototype.filter = function (callback) {
            var items = [];
        ...
        */
        AssetRegistry.prototype.find = function (name, type) {
