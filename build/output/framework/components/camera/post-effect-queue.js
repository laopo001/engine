pc.extend(pc, (function () {
     ...
     */
    var PostEffectQueue = /** @class */ (function () {
        ...
        PostEffectQueue.prototype._resizeOffscreenTarget = function (rt) {
            var rect = this.camera.rect;
            var width = Math.floor(rect.z * this.app.graphicsDevice.width * this.renderTargetScale);
            var height = Math.floor(rect.w * this.app.graphicsDevice.height * this.renderTargetScale);
            var device = this.app.graphicsDevice;
        ...
        PostEffectQueue.prototype.setRenderTargetScale = function (scale) {
         ...
         */
        PostEffectQueue.prototype.addEffect = function (effect) {
            ...
            if (!this.layer) {
                this.layer = new pc.Layer({
                    ...
                    onPostRender: function () {
                        for (var i_1 = 0; i_1 < this._commandList.length; i_1++) {
                            this._commandList[i_1]();
                        }
                    }
                });
         ...
         */
        PostEffectQueue.prototype.removeEffect = function (effect) {
        ...
        PostEffectQueue.prototype.requestDepthMap = function () {
            for (var i = 0, len = this.effects.length; i < len; i++) {
        ...
        PostEffectQueue.prototype.releaseDepthMap = function () {
            for (var i = 0, len = this.effects.length; i < len; i++) {
                var effect = this.effects[i].effect;
                if (effect.needsDepthBuffer) {
                    this.camera.releaseDepthMap();
         ...
         */
        PostEffectQueue.prototype.destroy = function () {
         ...
         */
        PostEffectQueue.prototype.enable = function () {
            if (!this.enabled && this.effects.length) {
                ...
                this.command = function () {
                    if (self_1.enabled) {
                        var rect = null;
                        var len = self_1.effects.length;
                        if (len) {
                            self_1.layer.renderTarget = self_1.effects[0].inputTarget;
                            //self.depthTarget = self.camera.camera._depthTarget;
                            for (var i = 0; i < len; i++) {
                                var fx = self_1.effects[i];
                                //if (self.depthTarget) fx.effect.depthMap = self.depthTarget.colorBuffer;
                                if (i === len - 1) {
                                    rect = self_1.camera.rect;
                                }
         ...
         */
        PostEffectQueue.prototype.disable = function () {
            if (this.enabled) {
                this.enabled = false;
        ...
        PostEffectQueue.prototype._onCanvasResized = function (width, height) {
            var rect = this.camera.rect;
            var device = this.app.graphicsDevice;
        ...
        PostEffectQueue.prototype.resizeRenderTargets = function () {
            if (this.resizeTimeout) {
        ...
        PostEffectQueue.prototype.onCameraRectChanged = function (name, oldValue, newValue) {
            if (this.enabled) {
...
//# sourceMappingURL=post-effect-queue.js.map