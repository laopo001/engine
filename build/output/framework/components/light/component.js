    ...
    var _defineProps = function (c, d, s) {
        ...
        _defineProperty("cookieAngle", 0, function (newValue, oldValue) {
            if (newValue !== 0 || this.cookieScale !== null) {
                ...
                var c_1 = Math.cos(newValue * pc.math.DEG_TO_RAD);
                var s_1 = Math.sin(newValue * pc.math.DEG_TO_RAD);
                this._cookieMatrix.set(c_1 / scx, -s_1 / scx, s_1 / scy, c_1 / scy);
        ...
        _defineProperty("cookieScale", null, function (newValue, oldValue) {
            if (newValue !== null || this.cookieAngle !== 0) {
                ...
                var scx = newValue.x;
                var scy = newValue.y;
                var c_2 = Math.cos(this.cookieAngle * pc.math.DEG_TO_RAD);
                var s_2 = Math.sin(this.cookieAngle * pc.math.DEG_TO_RAD);
                this._cookieMatrix.set(c_2 / scx, -s_2 / scx, s_2 / scy, c_2 / scy);
                this.light.cookieTransform = this._cookieMatrix;
            }
            else {
                this.light.cookieTransform = null;
