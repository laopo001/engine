pc.extend(pc, (function () {
    ...
    pc.extend(AudioSourceComponent.prototype, {
        ...
        onAssetChanged: function (_a, attribute, newValue, oldValue) {
            var name = _a.name;
        ...
        loadAudioSourceAssets: function (ids) {
            ...
            var _done = function () {
                _this.data.sources = sources;
                _this.data.currentSource = currentSource;
                if (_this.enabled && _this.activate && currentSource) {
                    _this.onEnable();
                }
            };
            assets.forEach(function (asset, index) {
                if (asset) {
                    ...
                    asset.ready(function (_a) {
                        var name = _a.name, resource = _a.resource;
