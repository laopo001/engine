pc.extend(pc, (function () {
     ...
     */
    var AudioSourceComponentSystem = function (_a, manager) {
        var systems = _a.systems;
        this.id = "audiosource";
    ...
    pc.extend(AudioSourceComponentSystem.prototype, {
        ...
        onInitialize: function (_a) {
            var audiosource = _a.audiosource, enabled = _a.enabled, _children = _a._children;
            if (audiosource &&
                enabled &&
                audiosource.enabled &&
