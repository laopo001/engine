pc.extend(pc, (function () {
    ...
    var SoundSlot = /** @class */ (function () {
         ...
         */
        SoundSlot.prototype.pause = function () {
            var paused = false;
         ...
         */
        SoundSlot.prototype.resume = function () {
            var resumed = false;
            var instances = this.instances;
            for (var i = 0, len = instances.length; i < len; i++) {
         ...
         */
        SoundSlot.prototype.stop = function () {
            var stopped = false;
            var instances = this.instances;
            for (var i = 0, len = instances.length; i < len; i++) {
                if (instances[i].stop())
         ...
         */
        SoundSlot.prototype.load = function () {
            if (!this._hasAsset())
                return;
         ...
         */
        SoundSlot.prototype.setExternalNodes = function (firstNode, lastNode) {
            if (!(firstNode)) {
         ...
         */
        SoundSlot.prototype.clearExternalNodes = function () {
            this._firstNode = null;
            this._lastNode = null;
            // update instances if not overlapping
            if (!this._overlap) {
         ...
         */
        SoundSlot.prototype.getExternalNodes = function () {
         ...
         */
        SoundSlot.prototype._hasAsset = function () {
            // != intentional
         ...
         */
        SoundSlot.prototype._createInstance = function () {
            var instance = null;
        ...
        SoundSlot.prototype._onInstancePlay = function (instance) {
            // propagate event to slot
            this.fire('play', instance);
            // propagate event to component
            this._component.fire('play', this, instance);
        };
        SoundSlot.prototype._onInstancePause = function (instance) {
            // propagate event to slot
            this.fire('pause', instance);
            // propagate event to component
            this._component.fire('pause', this, instance);
        };
        SoundSlot.prototype._onInstanceResume = function (instance) {
            // propagate event to slot
            this.fire('resume', instance);
            // propagate event to component
            this._component.fire('resume', this, instance);
        };
        SoundSlot.prototype._onInstanceStop = function (instance) {
            // propagate event to slot
            this.fire('stop', instance);
            // propagate event to component
            this._component.fire('stop', this, instance);
        };
        SoundSlot.prototype._onInstanceEnd = function (instance) {
        ...
        SoundSlot.prototype._onAssetAdd = function (asset) {
            this.load();
        };
        SoundSlot.prototype._onAssetLoad = function (asset) {
            this.load();
        };
        SoundSlot.prototype._onAssetRemoved = function (asset) {
            asset.off('remove', this._onAssetRemoved, this);
            this._assets.off("add:" + asset.id, this._onAssetAdd, this);
            this.stop();
        };
        SoundSlot.prototype.updatePosition = function (position) {
            var instances = this.instances;
            for (var i = 0, len = instances.length; i < len; i++) {
