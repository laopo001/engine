pc.extend(pc, (function () {
    ...
    */
    ...
    pc.extend(RigidBodyComponentSystem.prototype, {
         ...
         */
        raycastFirst: function (_a, _b, callback /*callback is deprecated*/) {
            var x = _a.x, y = _a.y, z = _a.z;
            var x = _b.x, y = _b.y, z = _b.z;
            var result = null;
        ...
        */
        ...
        onUpdate: function (dt) {
            ...
            for (i = 0; i < numManifolds; i++) {
                ...
                var forwardContacts = [];
                var reverseContacts = [];
                var newCollision = void 0, e0Events = void 0, e1Events = void 0;
                if (numContacts > 0) {
