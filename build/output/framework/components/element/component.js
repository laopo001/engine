            ...
            if (this._dirtyWorld) {
                if (this._parent === null) {
                    ...
                    if (screen) {
                        ...
                        if (parent_1 && parent_1.element && parent_1 !== screen) {
                            matA.setTRS(pc.Vec3.ZERO, parent_1.getLocalRotation(), parent_1.getLocalScale());
                            parentWorldTransform.mul2(parent_1.element._parentWorldTransform, matA);
                        }
