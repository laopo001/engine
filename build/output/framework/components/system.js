pc.extend(pc, (function () {
    ...
    var ComponentSystem = /** @class */ (function () {
         ...
         */
        ComponentSystem.prototype.store = function () {
         ...
         */
        ComponentSystem.prototype.cloneComponent = function (_a, clone) {
            var _guid = _a._guid;
         ...
         */
        ComponentSystem.prototype.initializeComponentData = function (component, data, properties) {
            data = data || {};
            // initialize
