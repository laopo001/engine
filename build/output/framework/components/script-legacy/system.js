pc.extend(pc, (function () {
    ...
    pc.extend(ScriptLegacyComponentSystem.prototype, {
        ...
        onPostInitialize: function (_a) {
            var enabled = _a.enabled, script = _a.script, _children = _a._children;
            if (enabled) {
        ...
        _callInstancesMethod: function (_a, method) {
            var data = _a.data;
            var instances = data.instances;
            for (var name_1 in instances) {
                if (instances.hasOwnProperty(name_1)) {
                    var instance = instances[name_1].instance;
                    if (instance[method]) {
        ...
        _destroyScriptComponent: function (script) {
            ...
            for (var name_2 in instances) {
                if (instances.hasOwnProperty(name_2)) {
                    var instance = instances[name_2].instance;
                    if (instance.destroy) {
                        instance.destroy();
                    }
                    if (instance.update) {
                    ...
                    if (script.instances[name_2].instance === script[name_2]) {
                        delete script[name_2];
                    }
                    delete script.instances[name_2];
                }
            }
        },
        ...
        _preRegisterInstance: function (_a, url, name, instance) {
            var script = _a.script, _guid = _a._guid;
            if (script) {
