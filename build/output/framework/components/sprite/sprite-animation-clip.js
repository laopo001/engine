pc.extend(pc, (function () {
     ...
     */
    var SpriteAnimationClip = /** @class */ (function () {
        function SpriteAnimationClip(component, _a) {
            var spriteAsset = _a.spriteAsset, name = _a.name, fps = _a.fps, loop = _a.loop;
        ...
        SpriteAnimationClip.prototype._bindSpriteAsset = function (asset) {
        ...
        SpriteAnimationClip.prototype._onSpriteAssetLoad = function (_a) {
            var resource = _a.resource, data = _a.data;
            if (!resource) {
                this.sprite = null;
            }
            else {
                if (!resource.atlas) {
                    var atlasAssetId = data.textureAtlasAsset;
        ...
        SpriteAnimationClip.prototype._onTextureAtlasLoad = function (atlasAsset) {
        ...
        SpriteAnimationClip.prototype._onSpriteAssetRemove = function (asset) {
            this.sprite = null;
        };
        // If the meshes are re-created make sure
        // we update them in the mesh instance
        SpriteAnimationClip.prototype._onSpriteMeshesChange = function () {
            if (this._component.currentClip === this) {
                this._component._showFrame(this.frame);
            }
        };
        // Update frame if ppu changes for 9-sliced sprites
        SpriteAnimationClip.prototype._onSpritePpuChanged = function () {
            if (this._component.currentClip === this) {
        ...
        */
        SpriteAnimationClip.prototype._update = function (dt) {
            if (this.fps === 0)
                return;
        ...
        SpriteAnimationClip.prototype._setTime = function (value) {
            this._time = value;
            var duration = this.duration;
            if (this._time < 0) {
                if (this.loop) {
        ...
        SpriteAnimationClip.prototype._setFrame = function (value) {
            if (this._sprite) {
                // clamp frame
        ...
        SpriteAnimationClip.prototype._destroy = function () {
            // remove sprite
            if (this._sprite)
                this._sprite = null;
            // remove sprite asset
        ...
        */
        SpriteAnimationClip.prototype.play = function () {
            if (this._playing)
                return;
            this._playing = true;
            this._paused = false;
        ...
        */
        SpriteAnimationClip.prototype.pause = function () {
        ...
        */
        SpriteAnimationClip.prototype.resume = function () {
            if (!this._paused)
                return;
            this._paused = false;
            this.fire('resume');
        ...
        */
        SpriteAnimationClip.prototype.stop = function () {
            if (!this._playing)
                return;
            this._playing = false;
            this._paused = false;
...
*/
//# sourceMappingURL=sprite-animation-clip.js.map