pc.extend(pc, (function () {
    ...
    CollisionComponentSystem.prototype = pc.extend(CollisionComponentSystem.prototype, {
        ...
        _getImplementation: function (_a) {
            var collision = _a.collision;
    ...
    var CollisionSystemImpl = /** @class */ (function () {
        ...
        CollisionSystemImpl.prototype.afterInitialize = function (component, data) {
            this.recreatePhysicalShapes(component);
            component.data.initialized = true;
        };
        // Called when a collision component changes type in order to recreate debug and physical shapes
        CollisionSystemImpl.prototype.reset = function (component, data) {
            this.beforeInitialize(component, data);
            this.afterInitialize(component, data);
        };
        // Re-creates rigid bodies / triggers
        CollisionSystemImpl.prototype.recreatePhysicalShapes = function (component) {
        ...
        // the collision.
        CollisionSystemImpl.prototype.createPhysicalShape = function (entity, data) {
            return undefined;
        };
        CollisionSystemImpl.prototype.updateTransform = function (_a, position, rotation, scale) {
            var entity = _a.entity;
            if (entity.trigger) {
                entity.trigger.syncEntityToBody();
            }
        ...
        CollisionSystemImpl.prototype.remove = function (_a, _b) {
            var rigidbody = _a.rigidbody, trigger = _a.trigger;
            var model = _b.model;
        ...
        CollisionSystemImpl.prototype.clone = function (_a, clone) {
            var _guid = _a._guid;
            var src = this.system.dataStore[_guid];
            var data = {
    ...
    CollisionBoxSystemImpl.prototype = pc.extend(CollisionBoxSystemImpl.prototype, {
        createPhysicalShape: function (entity, _a) {
            var halfExtents = _a.halfExtents;
            if (typeof Ammo !== 'undefined') {
                var he = halfExtents;
