    ...
    */
    var Application = /** @class */ (function () {
        function Application(canvas, options) {
            ...
            this.scene.on('set:layers', function (oldComp, _a) {
                var layerList = _a.layerList;
                var list = layerList;
                var layer;
        ...
        */
        Application.prototype.preload = function (callback) {
            var self = this;
            ...
            var count = function () { return _assets.count; };
            var i;
            if (_assets.length) {
        ...
        */
        Application.prototype.loadSceneSettings = function (url, callback) {
            ...
            this.loader.load(url, "scenesettings", function (err, settings) {
                if (!err) {
                    _this.applySceneSettings(settings);
                    if (callback) {
                        callback(null);
                    }
                }
        ...
        Application.prototype.loadScene = function (url, callback) {
            ...
            handler.load(url, function (err, data) {
                if (!err) {
                    ...
                    _this._preloadScripts(data, _loaded);
                }
                else {
                    if (callback) {
                        callback(err);
        ...
        Application.prototype._preloadScripts = function (sceneData, callback) {
            if (!pc.script.legacy) {
                callback();
                return;
            }
        ...
        Application.prototype._parseApplicationProperties = function (props, callback) {
            var i;
            var len;
        ...
        Application.prototype._loadLibraries = function (urls, callback) {
            var len = urls.length;
            var count = len;
            var self = this;
            var regex = /^http(s)?:\/\//;
        ...
        Application.prototype._parseAssets = function (assets) {
            var i, id;
            var list = [];
            var scriptsIndex = {};
            if (!pc.script.legacy) {
        ...
        Application.prototype._getScriptReferences = function (scene) {
            var i, key;
            var priorityScripts = [];
        ...
        Application.prototype._fillFrameStats = function (now, dt, ms) {
            // Timing stats
        ...
        */
        Application.prototype.setCanvasFillMode = function (mode, width, height) {
            this._fillMode = mode;
        ...
        */
        Application.prototype.setCanvasResolution = function (mode, width, height) {
        ...
        */
        Application.prototype.isHidden = function () {
        ...
        */
        Application.prototype.resizeCanvas = function (width, height) {
            if (!this._allowResize)
                return; // prevent resizing (e.g. if presenting in VR HMD)
        ...
        * been loaded
        */
        Application.prototype.onLibrariesLoaded = function () {
            this._librariesLoaded = true;
            this.systems.rigidbody.onLibraryLoaded();
            this.systems.collision.onLibraryLoaded();
        };
        Application.prototype.applySceneSettings = function (settings) {
            var asset;
        ...
        */
        Application.prototype.setSkybox = function (asset) {
            if (asset) {
        ...
        Application.prototype._onVrChange = function (enabled) {
            if (enabled) {
                if (!this.vr) {
        ...
        Application.prototype._onSkyboxChange = function (_a) {
            var resources = _a.resources;
            this.scene.setSkybox(resources);
        };
        Application.prototype._skyboxLoad = function (asset) {
            if (this.scene.skyboxMip === 0)
                asset.loadFaces = true;
            this.assets.load(asset);
            this._onSkyboxChange(asset);
        };
        Application.prototype._skyboxRemove = function (_a) {
            var id = _a.id;
            if (!this._skyboxLast)
                return;
        ...
        Application.prototype._firstBake = function () {
            this.lightmapper.bake(null, this.scene.lightmapMode);
        };
        Application.prototype._firstBatch = function () {
