pc.extend(pc, (() => {
    class ImageElement {
        ...
        set material(value) {
            if (! value) {
                const screenSpace = this._element.screen ? this._element.screen.screen.screenSpace : false;
    ...
    pc.extend(ImageElement.prototype, {
        ...
        _hasUserMaterial() {
            return !!this._materialAsset ||
                   (!!this._material &&
                    !this._system.defaultImageMaterials.includes(this._material));
        },
        ...
        _createMesh() {
            ...
            const mesh = pc.createMesh(this._system.app.graphicsDevice, this._positions, {uvs: this._uvs, normals: this._normals, indices: this._indices});
            this._updateMesh(mesh);

            return mesh;
        },

        _updateMesh({vertexBuffer, aabb}) {
            let i;
